const VERSION="voxel-survival-shell-v19";
const SHELL=["./","./index.html","./css/main.css","./css/menu.css","./css/hud.css","./css/mobile.css","./manifest.webmanifest","./js/main.js?v=19","./js/config.js?v=19","./js/QualityManager.js?v=19"];
