const VERSION="voxel-survival-shell-v16";
const SHELL=["./","./index.html","./css/main.css","./css/menu.css","./css/hud.css","./css/mobile.css","./manifest.webmanifest","./js/main.js?v=16","./js/config.js?v=16","./js/QualityManager.js?v=16"];
