const VERSION="voxel-survival-shell-v21";
const SHELL=["./","./index.html","./css/main.css","./css/menu.css","./css/hud.css","./css/mobile.css","./manifest.webmanifest","./js/main.js?v=21","./js/config.js?v=21","./js/QualityManager.js?v=21"];
